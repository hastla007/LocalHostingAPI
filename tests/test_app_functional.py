    ...
    def test_ui_authentication_flow(self):
        enable_response = self.client.post(
            ...
            data={
                ...
                "ui_auth_enabled": "on",
                "ui_username": "manager",
                "ui_password": "S3cureP@ssw0rd!",
                "ui_password_confirm": "S3cureP@ssw0rd!",
            },
            follow_redirects=True,
        )
        ...
        self.assertTrue(check_password_hash(config["ui_password_hash"], "S3cureP@ssw0rd!"))
        ...
        good_login = self.client.post(
            "/login",
            data={"username": "manager", "password": "S3cureP@ssw0rd!"},
            follow_redirects=True,
        )
